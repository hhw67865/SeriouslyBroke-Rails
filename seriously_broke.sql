...
--
-- Database "seriously_broke_development" dump
--
...
--
-- Name: seriously_broke_development; Type: DATABASE; Schema: -; Owner: -
--
...
--
-- Name: seriously_broke_development; Type: DATABASE PROPERTIES; Schema: -; Owner: -
--

ALTER DATABASE "seriously_broke_development" SET "TimeZone" TO 'utc';


\connect "seriously_broke_development"
...
CREATE DATABASE "seriously_broke_development" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.UTF8';
