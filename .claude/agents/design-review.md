...
- Open the live preview in Claude in Chrome
...
You use Claude in Chrome (the browser extension tools) for all browser automation and testing; there is no `agent-browser` skill or CLI. It handles:
...
Drive it step by step: navigate to the preview URL, screenshot at 1440px, resize to 768px and 375px and screenshot again. You can chain multiple actions in a single invocation.
